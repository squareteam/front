  ...
  describe('Response', function() {
    ...
    describe('API requests (no auth)', function() {
      ...
      it('should return data property is success', function() {
        ...
        $httpBackend.expectGET(apiURL + 'users').respond(200, '{"data":"test","errors":null}');
      ...
      it('should return ApiErrors in error property', function() {
        $httpBackend.expectGET(apiURL + 'users').respond(401, '{"data":null,"errors":["api.not_authorized"]}');
        $http.get('api://users').then(successCallback, errorCallback);
      ...
      it('should return ApiErrors in error property (special case)', function() {
        $httpBackend.expectGET(apiURL + 'users').respond(200, '{"data":null,"errors":["api.not_authorized"]}');
        $http.get('api://users').then(successCallback, errorCallback);
    ...
    describe('APIS requests (with auth)', function() {
      ...
      it('should return data property is success', function() {
        $httpBackend.expectGET(apiURL + 'users', {'Accept':'application/json, text/plain, */*','St-Identifier':'charly','St-Timestamp':1393369116,'St-Hash':'6a45267d89bf7ec8f068356e571656f9e64de0803bba2e5d8f2ee268182c0ab7', 'X-Requested-With':'XMLHttpRequest'}).respond(200, '{"data":"test","errors":null}');
      ...
      it('should return ApiErrors in error property', function() {
        $httpBackend.expectGET(apiURL + 'users', {'Accept':'application/json, text/plain, */*','St-Identifier':'charly','St-Timestamp':1393369116,'St-Hash':'6a45267d89bf7ec8f068356e571656f9e64de0803bba2e5d8f2ee268182c0ab7', 'X-Requested-With':'XMLHttpRequest'}).respond(401, '{"data":null,"errors":["api.not_authorized"]}');
        $http.get('apis://users').then(successCallback, errorCallback);
      ...
      it('should return ApiErrors in error property (special case)', function() {
        $httpBackend.expectGET(apiURL + 'users', {'Accept':'application/json, text/plain, */*','St-Identifier':'charly','St-Timestamp':1393369116,'St-Hash':'6a45267d89bf7ec8f068356e571656f9e64de0803bba2e5d8f2ee268182c0ab7', 'X-Requested-With':'XMLHttpRequest'}).respond(200, '{"data":null,"errors":["api.not_authorized"]}');
        $http.get('apis://users').then(successCallback, errorCallback);
      ...
      it('should return HttpError in error property', function() {
        $httpBackend.expectGET(apiURL + 'users', {'Accept':'application/json, text/plain, */*','St-Identifier':'charly','St-Timestamp':1393369116,'St-Hash':'6a45267d89bf7ec8f068356e571656f9e64de0803bba2e5d8f2ee268182c0ab7', 'X-Requested-With':'XMLHttpRequest'}).respond(401, '');
        $http.get('apis://users').then(successCallback, errorCallback);
